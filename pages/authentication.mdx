...
<Card title="Nota Importante" icon="info" horizontal>
  O endpoint (`https://api.staging.parcelemais.com.br/integration`) é utilizado para o ambiente de desenvolvimento caso queira utilizar em produção utilize (`https://api.parcelemais.com.br/integration`).
</Card>
