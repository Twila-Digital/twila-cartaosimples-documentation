...
<Card icon="light-emergency-on" horizontal>
  ...
  * A CartãoSimples nunca solicitará suas credenciais
</Card>
...
```bash
curl -X POST https://api.staging.CartãoSimples.com.br/integration/v1/authentication/accesstoken \
...
<Card title="Nota Importante" icon="info" horizontal>
  O endpoint (`https://api.staging.cartaosimples.com.br/integration`) é utilizado para o ambiente de desenvolvimento caso queira utilizar em produção utilize (`https://api.cartaosimples.com.br/integration`).
</Card>
